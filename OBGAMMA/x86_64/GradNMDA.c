...
#define nrn_init _nrn_init__gradNMDA
#define _nrn_initial _nrn_initial__gradNMDA
#define nrn_cur _nrn_cur__gradNMDA
#define _nrn_current _nrn_current__gradNMDA
#define nrn_jacob _nrn_jacob__gradNMDA
#define nrn_state _nrn_state__gradNMDA
#define _net_receive _net_receive__gradNMDA 
#define state state__gradNMDA 
...
#define F F_gradNMDA
#define _f_mgblock _f_mgblock_gradNMDA
#define mgblock mgblock_gradNMDA
 extern double F( double );
 extern double _f_mgblock( double );
 extern double mgblock( double );
 /* declare global and static user variables */
#define mg mg_gradNMDA
 double mg = 1;
#define usetable usetable_gradNMDA
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_gradNMDA", 0, 1,
 0,0,0
};
 ...
 "mg_gradNMDA", &mg_gradNMDA,
 "usetable_gradNMDA", &usetable_gradNMDA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 gradNMDA /home/jv/OBGAMMA/GradNMDA.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 46 in file GradNMDA.mod:\n  SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jv/OBGAMMA/GradNMDA.mod";
static const char* nmodl_file_text = 
