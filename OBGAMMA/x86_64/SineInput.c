...
#define nrn_init _nrn_init__IClampSine
#define _nrn_initial _nrn_initial__IClampSine
#define nrn_cur _nrn_cur__IClampSine
#define _nrn_current _nrn_current__IClampSine
#define nrn_jacob _nrn_jacob__IClampSine
#define nrn_state _nrn_state__IClampSine
#define _net_receive _net_receive__IClampSine 
...
#define ival _p[6]
#define ival_columnindex 6
#define amp _p[7]
#define amp_columnindex 7
#define noise _p[8]
#define noise_columnindex 8
#define res _p[9]
#define res_columnindex 9
#define on _p[10]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 IClampSine /home/jv/OBGAMMA/SineInput.mod\n");
...
#endif
{
 ...
 if ( on ) {
     res = 0.5 * sin ( 2.0 * pi * f * ( t / 1000.0 - 0.25 / f ) ) + 0.5 ;
     ival = A * res + bias ;
     }
   else {
     ival = 0.0 ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jv/OBGAMMA/SineInput.mod";
static const char* nmodl_file_text = 
  "\n"
  "NEURON {\n"
