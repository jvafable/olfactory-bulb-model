...
#define nrn_init _nrn_init__ICa
#define _nrn_initial _nrn_initial__ICa
#define nrn_cur _nrn_cur__ICa
#define _nrn_current _nrn_current__ICa
#define nrn_jacob _nrn_jacob__ICa
#define nrn_state _nrn_state__ICa
#define _net_receive _net_receive__ICa 
#define _f_rates _f_rates__ICa 
#define rates rates__ICa 
#define states states__ICa 
...
#define rtau rtau_ICa
 double rtau = 0;
#define rinf rinf_ICa
 double rinf = 0;
#define stau stau_ICa
 double stau = 0;
#define sinf sinf_ICa
 double sinf = 0;
#define usetable usetable_ICa
 double usetable = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 ICa /home/jv/OBGAMMA/LCa.mod\n");
...
{
 { error =  states();
 if(error){fprintf(stderr,"at line 54 in file LCa.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jv/OBGAMMA/LCa.mod";
static const char* nmodl_file_text = 
