...
#define rate rate__Ican 
#define state state__Ican 
...
#define Shm _p[1]
#define Shm_columnindex 1
#define i _p[2]
#define i_columnindex 2
#define minf _p[3]
#define minf_columnindex 3
#define tauinf _p[4]
#define tauinf_columnindex 4
#define m _p[5]
#define m_columnindex 5
#define g _p[6]
#define g_columnindex 6
#define MCa _p[7]
#define MCa_columnindex 7
#define mm _p[8]
#define mm_columnindex 8
#define Dm _p[9]
#define Dm_columnindex 9
#define Dg _p[10]
#define Dg_columnindex 10
#define DMCa _p[11]
#define DMCa_columnindex 11
#define Dmm _p[12]
#define Dmm_columnindex 12
#define cai _p[13]
...
#define e e_Ican
 double e = 10;
#define kdcan kdcan_Ican
 double kdcan = 0.2;
#define tauca tauca_Ican
 double tauca = 800;
 ...
 "e_Ican", &e_Ican,
 "tauca_Ican", &tauca_Ican,
 "kdcan_Ican", &kdcan_Ican,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "cvodeieq");
 	...
 	ivoc_help("help ?1 Ican /home/jv/OBGAMMA/Can.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Calcium dependent non-specific cation channel ";
...
/*CVODE*/
 ...
 rate ( _threadargscomma_ v ) ;
 Dm = Dm  / (1. - dt*( ( ( ( - 1.0 ) ) ) / tauinf )) ;
  return 0;
}
 /*END CVODE*/
 static int state (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) { {
   rate ( _threadargscomma_ v ) ;
    m = m + (1. - exp(dt*(( ( ( - 1.0 ) ) ) / tauinf)))*(- ( ( ( minf ) ) / tauinf ) / ( ( ( ( - 1.0 ) ) ) / tauinf ) - m) ;
   }
  return 0;
}
 
static int  rate ( _threadargsprotocomma_ double _lv ) {
    minf = 1.0 / ( 1.0 + exp ( - ( 43.0 + _lv - Shm ) / 5.2 ) ) ;
   tauinf = 1.6 + 2.7 / ( exp ( ( - 55.0 - _lv ) / 15.0 ) + exp ( ( - 55.0 - _lv ) / ( - 15.0 ) ) ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jv/OBGAMMA/Can.mod";
static const char* nmodl_file_text = 
