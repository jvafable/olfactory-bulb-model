...
#define nrn_init _nrn_init__hpg
#define _nrn_initial _nrn_initial__hpg
#define nrn_cur _nrn_cur__hpg
#define _nrn_current _nrn_current__hpg
#define nrn_jacob _nrn_jacob__hpg
#define nrn_state _nrn_state__hpg
#define _net_receive _net_receive__hpg 
#define rate rate__hpg 
#define states states__hpg 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_hpg", _hoc_setdata,
 "alpt_hpg", _hoc_alpt,
 "bett_hpg", _hoc_bett,
 "rate_hpg", _hoc_rate,
 0, 0
};
#define alpt alpt_hpg
#define bett bett_hpg
...
#define gmt gmt_hpg
 double gmt = 0.5;
#define linf linf_hpg
 double linf = 0;
#define q10 q10_hpg
 double q10 = 4.5;
#define taul taul_hpg
 double taul = 0;
#define vhalft vhalft_hpg
 double vhalft = -65;
#define zetat zetat_hpg
 double zetat = 0.085;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 hpg /home/jv/OBGAMMA/hpg.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "I-h channel for juxtaglomerular cells ";
...
{
 { error =  states();
 if(error){fprintf(stderr,"at line 65 in file hpg.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jv/OBGAMMA/hpg.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "-----------------------------------------------------------------------------\n"
  "\n"
