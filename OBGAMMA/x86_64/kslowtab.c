...
#define nrn_init _nrn_init__kslowtab
#define _nrn_initial _nrn_initial__kslowtab
#define nrn_cur _nrn_cur__kslowtab
#define _nrn_current _nrn_current__kslowtab
#define nrn_jacob _nrn_jacob__kslowtab
#define nrn_state _nrn_state__kslowtab
#define _net_receive _net_receive__kslowtab 
#define rates rates__kslowtab 
#define states states__kslowtab 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kslowtab", _hoc_setdata,
 "rates_kslowtab", _hoc_rates,
 "table_tabktau_kslowtab", _hoc_table_tabktau,
 "tabktau_kslowtab", _hoc_tabktau,
 "table_tabkinf_kslowtab", _hoc_table_tabkinf,
 "tabkinf_kslowtab", _hoc_tabkinf,
 "table_tabntau_kslowtab", _hoc_table_tabntau,
 "tabntau_kslowtab", _hoc_tabntau,
 "table_tabninf_kslowtab", _hoc_table_tabninf,
 "tabninf_kslowtab", _hoc_tabninf,
 0, 0
};
#define table_tabktau table_tabktau_kslowtab
#define tabktau tabktau_kslowtab
#define table_tabkinf table_tabkinf_kslowtab
#define tabkinf tabkinf_kslowtab
#define table_tabntau table_tabntau_kslowtab
#define tabntau tabntau_kslowtab
#define table_tabninf table_tabninf_kslowtab
#define tabninf tabninf_kslowtab
...
#define ktau ktau_kslowtab
 double ktau = 0;
#define kinf kinf_kslowtab
 double kinf = 0;
#define ntau ntau_kslowtab
 double ntau = 0;
#define ninf ninf_kslowtab
 double ninf = 0;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gkbar_kslowtab", 0, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ntau_kslowtab", "ms",
 "ktau_kslowtab", "ms",
 "gkbar_kslowtab", "mho/cm2",
 "ik_kslowtab", "mA/cm2",
 0,0
};
 ...
 "ninf_kslowtab", &ninf_kslowtab,
 "kinf_kslowtab", &kinf_kslowtab,
 "ntau_kslowtab", &ntau_kslowtab,
 "ktau_kslowtab", &ktau_kslowtab,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kslowtab /home/jv/OBGAMMA/kslowtab.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "HH slow potassium channel with FUNCTION_TABLEs";
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 46 in file kslowtab.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jv/OBGAMMA/kslowtab.mod";
static const char* nmodl_file_text = 
