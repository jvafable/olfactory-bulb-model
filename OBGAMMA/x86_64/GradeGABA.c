...
#define nrn_init _nrn_init__gradGABA
#define _nrn_initial _nrn_initial__gradGABA
#define nrn_cur _nrn_cur__gradGABA
#define _nrn_current _nrn_current__gradGABA
#define nrn_jacob _nrn_jacob__gradGABA
#define nrn_state _nrn_state__gradGABA
#define _net_receive _net_receive__gradGABA 
#define state state__gradGABA 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 gradGABA /home/jv/OBGAMMA/GradeGABA.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 40 in file GradeGABA.mod:\n  SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jv/OBGAMMA/GradeGABA.mod";
static const char* nmodl_file_text = 
  ...
  "PARAMETER {\n"
  "  gmax  = 1e-3 (uS)\n"
  "  alpha = 0.8 (/ms)    : 1.25 ms\n"
  "  beta  = 0.0556 (/ms) : 18 ms\n"
  "  e = -80	  (mV)     : Reserval potential\n"
  "  thetasyn = -40 (mV)  : Activation threshold\n"
  "  sigma    =  2\n"
  "}\n"
  "\n"
